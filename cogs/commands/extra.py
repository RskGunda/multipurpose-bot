...
cluster = motor.motor_asyncio.AsyncIOMotorClient(
    "mongodb+srv://rlx:rlx@rlx.iv0gv.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
)
...
class Utility(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.db = self.connection["VortexBot"]["servers"]
    ...
    async def stats(self, ctx):
        """Shows some usefull information about VortexBot"""
        ...
        embed = discord.Embed(
            color=0x2f3136,
            description=
            "[Invite](https://discord.com/oauth2/authorize?client_id=1200343838947029082&permissions=2113268958&scope=bot) ● [Support Server](https://discord.gg/bYqgRqGWcT)"
        )
        ...
        Sameer = await self.bot.fetch_user(940423037684154439)
        Mehtab = await self.bot.fetch_user(913342998031507466)
  

        embed.add_field(
            name='﹒DEVELOPERS',
            value=
            f"[{Sameer}](https://discord.com/users/940423037684154439)\n[{Mehtab}](https://discord.com/users/913342998031507466)"
        )

        embed.set_author(name=f"{self.bot.user.name} Stats",
                         icon_url=self.bot.user.display_avatar.url)
        embed.set_thumbnail(url=self.bot.user.display_avatar.url)
        embed.set_footer(text='Thanks For Using VortexBot',
                         icon_url=self.bot.user.display_avatar.url)
    ...
    async def invite(self, ctx: commands.Context):
        embed = discord.Embed(
            description=
            "> • [Click Here To Invite VortexBot To Your Server](https://discord.com/oauth2/authorize?client_id=1200343838947029082&permissions=2113268958&scope=bot)\n> • [Click Here To Join My Support Server](https://discord.gg/bYqgRqGWcT)",
            color=0x2f3136)
