...
class Check:
    ...
    async def userInVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            title="VortexBot",
            description=
            f"<:anxAlert:1108101889687560336> {ctx.author.mention} You are not connected in a voice channel",
            color=0x2f3136)
    ...
    async def botInVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            title="VortexBot",
            description=
            f"<:anxAlert:1108101889687560336> {ctx.author.mention} I'm not connected in a voice channel",
            color=0x2f3136)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def botNotInVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            title="VortexBot",
            description=
            f"<:anxAlert:1108101889687560336> I'm already connected in a voice channel",
            color=0x2f3136)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def userAndBotInSameVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            title="VortexBot",
            description=
            f"<:anxAlert:1108101889687560336> You are not connected in the same voice channel that the bot",
            color=0x2f3136)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def botIsPlaying(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            title="VortexBot",
            description=
            f"<:anxAlert:1108101889687560336> There is currently no song to replay",
            color=0x2f3136)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
...
#<:volume_down:1056039813712707654>
    ...
    async def volume_button(self, interaction: discord.Interaction,
        ...
        if player is None:
            hacker = discord.Embed(
                description=
                "<:anxAlert:1108101889687560336> | I am not connected to a voice channel.",
                color=0x2f3136)
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:anxTIck:1107932353654956043>> | Successfully changed player volume to : `50`",
                color=0x2f3136)
            ...
            hacker2 = discord.Embed(
                description=
                f"<:anxAlert:1108101889687560336> | I am not playing anything.",
                color=0x2f3136)
    ...
    async def seek_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:anxTIck:1107932353654956043>> | Seeked the current player to `10 seconds` .",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
            hacker2 = discord.Embed(
                description=
                "<:anxAlert:1108101889687560336> | I am not playing anything.",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker2,
                                                           ephemeral=True)
    ...
    async def stop_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                f"<:anxTIck:1107932353654956043>> | Destroyed the player.",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
    ...
    async def skip_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:anxTIck:1107932353654956043>> | Successfully Skipped the track .",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
    ...
    async def vol_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:anxTIck:1107932353654956043>> | Successfully changed player volume to : `100`",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
...
class Music(commands.Cog):
    ...
    async def play(self, ctx: commands.Context, *, search: str):
        ...
        if not getattr(ctx.author, "voice", None):
            nv = discord.Embed(
                description=
                f'<:anxAlert:1108101889687560336> | You are not connected to a voice channel.',
                color=0x2f3136)
        ...
        if not ctx.voice_client:
            ...
            await ctx.send(
                f"<:anxTIck:1107932353654956043>> | Successfully Connected To {ctx.author.voice.channel.mention}"
            )
        else:
    ...
    async def connect(self,
        ...
        if channel is None:
            ...
            av = discord.Embed(
                description=
                f"<:anxAlert:1108101889687560336> | I am already connected to a voice channel.",
                color=0x2f3136)
        ...
        sc = discord.Embed(
            description=
            f"<:anxTIck:1107932353654956043>> | Successfully connected to {channel.mention}.",
            color=0x2f3136)
    ...
    async def leave_command(self, ctx: commands.Context):
        ...
        hacker1 = discord.Embed(
            description=
            f"<:anxTIck:1107932353654956043>> | Successfully disconnected from {ctx.author.voice.channel.mention}",
            color=0x2f3136)
    ...
    async def skip_command(self, ctx: commands.Context):
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                f"<:anxTIck:1107932353654956043>> | Successfully Skipped the track .",
                color=0x2f3136)
    ...
    async def pause_command(self, ctx: commands.Context):
        ...
        if not player.is_paused():
            if player.is_playing():
                ...
                hacker1 = discord.Embed(
                    description=
                    f"<:anxTIck:1107932353654956043>> | Successfully paused the player .",
                    color=0x2f3136)
                view = Buttons()
                await ctx.send(embed=hacker1)
            else:
            ...
            hacker3 = discord.Embed(
                description=
                f"<:anxAlert:1108101889687560336> | Player is already paused .",
                color=0x2f3136)
    ...
    async def resume_command(self, ctx: commands.Context):
        ...
        if player.is_paused():
            ...
            hacker1 = discord.Embed(
                description=
                f"<:anxTIck:1107932353654956043>> | Successfully resumed the player .",
                color=0x2f3136)
            ...
            hacker3 = discord.Embed(
                description=
                f"<:anxAlert:1108101889687560336> | Player is already resumed .",
                color=0x2f3136)
    ...
    async def volume(self, ctx, volume):
        ...
        if ((not volume.isdigit()) or (int(volume)) < 0
            ...
            hacker = discord.Embed(
                description=
                "<:anxAlert:1108101889687560336> | Volume Must Be 0 To 500 .",
                color=0x2f3136)
            hacker.set_footer(text=f"Requested By {ctx.author}",
                              icon_url=f"{ctx.author.avatar}")
            #hacker.set_thumbnail(url = f"{ctx.author.avatar}")
        ...
        hacker4 = discord.Embed(
            description=
            f"<:anxTIck:1107932353654956043>> | Successfully changed player volume to : `{volume}%`",
            color=0x2f3136)
    ...
    async def playing(self, ctx):
        if not ctx.voice_client:
            hacker = discord.Embed(
                description=
                "<:anxAlert:1108101889687560336> | Not connected to a voice channel.",
                color=0x2f3136)
            hacker.set_footer(text=f"Requested By {ctx.author}",
                              icon_url=f"{ctx.author.avatar}")
            hacker.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def shuffle(self, ctx):
        ...
        hacker2 = discord.Embed(
            description=
            "<:anxTIck:1107932353654956043>> | Successfully shuffled the current queue .",
            color=0x2f3136)
    ...
    async def pull(self, ctx, index: int):
        ...
        if index > len(vc.queue) or index < 1:
            hacker2 = discord.Embed(
                description=
                f"<:anxAlert:1108101889687560336> | Must Be Between 1 And {len(vc.queue)} .",
                color=0x2f3136)
            return await ctx.reply(embed=hacker2)
        ...
        hacker3 = discord.Embed(
            description=
            f"<:anxTIck:1107932353654956043>> | Successfully pulled out `{removed.title}` From Queue .",
            color=0x2f3136)
    ...
    async def _queue(self, ctx):
        if not ctx.voice_client:
            ...
            hacker1 = discord.Embed(
                description=
                "<:anxAlert:1108101889687560336> | You need to join a voice channel to play something .",
                color=0x2f3136)
            return await ctx.send(embed=hacker1)
        else:
            vc: wavelink.Player = ctx.voice_client
        ...
        if vc.queue.is_empty:
            hacker3 = discord.Embed(
                description=
                f"<:anxAlert:1108101889687560336> | No songs in queue .",
                color=0x2f3136)
    ...
    async def _clear(self, ctx):
        ...
        hacker3 = discord.Embed(
            description=
            f"<:anxTIck:1107932353654956043>> | Successfully Clears The current Queue .",
            color=0x2f3136)
        hacker3.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        return await ctx.send(embed=hacker3)
    ...
    async def seek_command(self, ctx, position: str):
        ...
        hacker3 = discord.Embed(
            description=
            f"<:anxTIck:1107932353654956043>> | Successfully Seeked the current player to {secs} .",
            color=0x2f3136)
