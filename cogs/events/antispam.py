    ...
    async def on_message(self, message):
      ...
      try:
                if antiSpam is True:
                 ...
                 #   if not punish_cd_bucket.update_rate_limit():
                      ...
                      if data["punishment"] == "ban":
                        now = discord.utils.utcnow()
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="VortexBot | Anti Spam")
                ...
                if antiLink is True:
                    ...
                    if link_matches:
                        if data["punishment"] == "kick":
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="VortexBot | Anti Link")
