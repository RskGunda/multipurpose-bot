...
@tree.command(name="embed", description="Create A Embed Using VortexBot")
...
async def on_command_completion(context: Context) -> None:
    ...
    hacker = client.get_channel(940423037684154439)
    if context.guild is not None:
        try:
            ...
            embed.add_field(
                ...
                inline=False)
            embed.set_footer(text="Powered By Sameer",
        ...
        try:
            ...
            embed1.add_field(
                ...
                f"{context.author} | ID: [{context.author.id}](https://discord.com/users/{context.author.id})",
                inline=False)
            embed1.set_footer(text="Powered By Vortex",
                              icon_url=client.user.display_avatar.url)
